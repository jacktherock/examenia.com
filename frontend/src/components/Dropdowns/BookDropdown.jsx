        ...
        <>
            ...
            <div className="dropdown-menu dropstart dropdown-menu-lg-end" aria-labelledby="book-dropdown">
                ...
                {/* <div className="dropdown dropend"> */}
                    {/* <Link className="dropdown-item dropdown-toggle" to="#" id="book-dropdown-layouts01"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Engineering</Link> */}

                    {/* <div className="dropdown-menu" aria-labelledby="book-dropdown-layouts01"> */}
                        {/* Computer Dropdown */}
                        <div className="dropdown dropend">
                            <Link className="dropdown-item dropdown-toggle" to="#" id="book-dropdown-layouts02"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Computer Engineering</Link>

                            <div className="dropdown-menu dropdown-menu-lg-end" aria-labelledby="book-dropdown-layouts02">
                        ...
                        {/* Mechanical Dropdown */}
                        <div className="dropdown dropend">
                            <Link className="dropdown-item dropdown-toggle" to="#" id="book-dropdown-layouts03"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mechanical Engineering</Link>
                            <div className="dropdown-menu dropdown-menu-lg-end" aria-labelledby="book-dropdown-layouts03">
                                <Link className="dropdown-item" to="#">Second Year</Link>
                                <Link className="dropdown-item" to="#">Third Year</Link>
                                <Link className="dropdown-item" to="#">Final Year</Link>
                            </div>
                        ...
                        {/* Electrical Dropdown */}
                        <div className="dropdown dropend">
                            <Link className="dropdown-item dropdown-toggle" to="#" id="book-dropdown-layouts04"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Electrical Engineering</Link>
                            <div className="dropdown-menu dropdown-menu-lg-end" aria-labelledby="book-dropdown-layouts04">
                                <Link className="dropdown-item" to="#">Second Year</Link>
                                <Link className="dropdown-item" to="#">Third Year</Link>
                                <Link className="dropdown-item" to="#">Final Year</Link>
                            </div>
